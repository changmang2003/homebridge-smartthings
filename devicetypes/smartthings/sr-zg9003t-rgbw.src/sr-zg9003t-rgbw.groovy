...
metadata {
    definition (name: "SR-ZG9003T-RGBW", namespace: "SmartThings", author: "Yu Chang Mang") {
    capability "Actuator"
    capability "Sensor"
    capability "Battery"
    capability "Button"
    ...
    attribute "sceneNumber", "number"
        ...
        fingerprint endpointId: "01", profileId: "0104", manufacturer: "SR", model: "ZGRC-TUS-002", deviceJoinName: "SR-ZG9003T-RGBW"
