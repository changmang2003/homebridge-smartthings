 ...
 */
metadata {
	definition(name: "Aeotec Inc Nano Switch", namespace: "SmartThings", author: "Yu Chang Mang", ocfDeviceType: "oic.d.switch", minHubCoreVersion: '000.017.0012', executeCommandsLocally: false) {
		...
		fingerprint deviceId: "0x1001",inClusters: "0x5E, 0x25, 0x27, 0x32, 0x81, 0x71, 0x2C, 0x2B, 0x70, 0x86, 0x72, 0x73, 0x85, 0x59, 0x7A, 0x5A",outClusters: "0x82"
	...
	tiles(scale: 2) {
		...
		details(["switch", "power", "energy",childDeviceTiles("all"), "refresh", "configure", "reset"])
	}
}
