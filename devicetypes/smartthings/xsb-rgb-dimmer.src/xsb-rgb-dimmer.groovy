...
metadata {
	...
	definition (name: "XSB RGB Dimmer", namespace: "smartthings", author: "SmartThings") {
		...
		fingerprint profileId: "0104", inClusters: "0000,0003,0004,0005,0006,0008,0300,0B05", outClusters: "0019", manufacturer: "SR", model: "RGBW Lighting", deviceJoinName: "Sunricher RGBW LED Controller"
	}
