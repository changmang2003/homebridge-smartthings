...
metadata {
 definition(name: "Lightify Dimming Switch- Zigbee", namespace: "adamoutler", author: "Adam Amber House") {
  ...
  fingerprint profileId: "0104", deviceId: "0001", inClusters: "0000, 0001, 0003, 0B05", outClusters: "0003, 0005, 0006, 0008, 0019, 0300",manufacturer: "SR", model: " ZGRC-TUS-006", deviceJoinName: "SR-ZG9001T-DIM"
 }
